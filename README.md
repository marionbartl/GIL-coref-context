...
This repository holds the code and data used for our paper [Adapting Psycholinguistic Research for LLMs: Gender-inclusive Language in a Coreference Context](https://arxiv.org/abs/2502.13120), accepted for publication at the 6th Gender Bias in NLP Workshop at ACL 2025. 
...
The original catalogue of gendered terms and gender neutral replacements (Bartl et al., 2024; [github.com/marionbartl/affixed_words](https://github.com/marionbartl/affixed_words)) is contained in the file `replacements+plural-final.csv`. 
